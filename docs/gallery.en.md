...
|---|---|---|
| Compare spectra or condition-dependent curves | XPS/XRD/PL/UV-Vis/FTIR/NMR spectral routes | shared X + one or more Y columns |
| Compare group levels with uncertainty | bar, line-error, or forest | category/X + value + explicit SD/SEM/CI |
| Show raw distributions and outlier shape | raw points, box, violin, or Raincloud | group + every raw observation |
| Show a regular numeric matrix | heatmap or confusion matrix | row labels + numeric matrix columns |
| Show positive flow or composition transfer | Sankey | Source + Target + Value |
| Compare directed, signed, weighted relations across panels | circular network | Panel + Source + Target + Weight; optional Sign |
| Present medical-model evidence | ROC/PR/calibration/DCA/Bland-Altman | precomputed coordinates or statistics |

<div align="center">
<img src="../assets/gallery/bar-error-groups.png" alt="grouped bar with SD error bars" width="31%" />
...
<img src="../assets/gallery/ftir-temperature-series.png" alt="FTIR temperature series comparison" width="31%" />
<img src="../assets/gallery/heatmap-dense-30x30.png" alt="dense 30 by 30 heatmap matrix" width="31%" />
<img src="../assets/gallery/histogram-frozen-bins.png" alt="histogram frequency distribution" width="31%" />
<img src="../assets/gallery/horizontal-long-labels.png" alt="horizontal bar for long labels" width="31%" />
<img src="../assets/gallery/line-error.png" alt="trend with SD and SEM error bars" width="31%" />
<img src="../assets/gallery/lsv-multi.png" alt="LSV linear sweep" width="31%" />
<img src="../assets/gallery/medical-agreement.png" alt="Bland Altman medical measurement agreement" width="31%" />
<img src="../assets/gallery/medical-calibration.png" alt="medical model calibration curve reliability" width="31%" />
<img src="../assets/gallery/medical-confusion.png" alt="medical classification confusion matrix" width="31%" />
...
<img src="../assets/gallery/xps-comparison.png" alt="XPS multi-spectrum comparison" width="31%" />
<img src="../assets/gallery/xps-fit.png" alt="XPS peak fitting" width="31%" />
<img src="../assets/gallery/xrd-multi.png" alt="XRD multi-series comparison" width="31%" />
</div>
